...
Before product-behavior testing, run the root `AGENTS.md` operating-identity self-check and inject the host provider through `docker/run-hewo-e2e.sh`; see `.agents/knowledge/provider-e2e.md`.
