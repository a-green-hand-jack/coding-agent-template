...
Machine-specific facts — the contents of `development-machine-facts.md` and any rendered `DevelopmentMachine.md` — are device-local by design. In a public repository keep only the neutral skeleton; never commit endpoint, model, host, or smoke-evidence observations.
